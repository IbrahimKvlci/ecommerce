...
import com.ibrahimkvlci.ecommerce.bus.payment.PaymentCheckoutFailEvent;
...
public class OrderCheckoutAppBus {
     ...
     */
    private SaleResponse convertPaymentToOrderSaleResponse(
            com.ibrahimkvlci.ecommerce.payment.dto.SaleResponse paymentResponse) {
    ...
    public SaleResponse okCheckout(PaymentCheckoutSuccessEvent event) {
        SaleResponse orderSaleResponse = convertPaymentToOrderSaleResponse(event.getSaleResponse());
    ...
    @EventListener
    public SaleResponse failCheckout(PaymentCheckoutFailEvent event) {
        SaleResponse orderSaleResponse = convertPaymentToOrderSaleResponse(event.getSaleResponse());
