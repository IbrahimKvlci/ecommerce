...
public class PaymentDetailServiceImpl implements PaymentDetailService {
    ...
    public PaymentDetail createPaymentDetail(PaymentDetail paymentDetail) {
        ...
        PaymentMethod paymentMethod = paymentMethodRepository
                .findById(Objects.requireNonNull(paymentDetail.getPaymentMethod().getId()))
                .orElseThrow(() -> new PaymentDetailValidationException(
                        "Payment method with ID " + paymentDetail.getPaymentMethod().getId() + " not found"));
    ...
    public PaymentDetail updatePaymentDetail(Long id, PaymentDetail paymentDetail) {
        ...
        PaymentDetail existingPaymentDetail = paymentDetailRepository.findById(Objects.requireNonNull(id))
    ...
    public PaymentDetail mapToEntity(PaymentDetailDTO paymentDetailDTO) {
        ...
        // paymentDetail.setPaid(paymentDetailDTO.getIsPaid() != null ?
        // paymentDetailDTO.getIsPaid() : false);
